...
let BusinessService = class BusinessService {
    ...
    async update(id, data) {
        ...
        if (!business) {
            throw new common_1.HttpException(`Business with ID ${id} does not exist`, common_1.HttpStatus.NOT_FOUND);
        }
        this.repo.merge(business, data);
        await this.repo.update({ id: id }, business).catch(err => {
            throw new common_1.HttpException(`Update business ${id} failed: ${err}`, common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        });
...
exports.BusinessService = BusinessService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(business_1.Business)),
